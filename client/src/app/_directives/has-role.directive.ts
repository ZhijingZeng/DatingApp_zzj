...
@Directive({
  selector: '[appHasRole]' //*appHasRole ='["Admin","thing"]' structural directive: remove element from the dom 
})
...
export class HasRoleDirective implements OnInit {
  ...
  ngOnInit(): void {
    if(this.user.roles.some(r => this.appHasRole.includes(r))){
      ...
      this.viewContainerRef.clear(); //the "admin" bar will be removed from the dom
    }   
  }
